...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | Connection to DC1-LEAF1-Ethernet1 | routed | - | 172.31.255.0/31 | default | 1500 | false | - | - |
| Ethernet2 | Connection to DC1-LEAF2-Ethernet1 | routed | - | 172.31.255.4/31 | default | 1500 | false | - | - |
| Ethernet3 | Connection to DC1-LEAF3-Ethernet1 | routed | - | 172.31.255.8/31 | default | 1500 | false | - | - |
| Ethernet4 | Connection to DC1-LEAF4-Ethernet1 | routed | - | 172.31.255.12/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description Connection to DC1-LEAF1-Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description Connection to DC1-LEAF2-Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description Connection to DC1-LEAF3-Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description Connection to DC1-LEAF4-Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65100
   ...
   neighbor 172.31.255.1 description DC1-LEAF1_Ethernet1
   neighbor 172.31.255.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.5 remote-as 65101
   neighbor 172.31.255.5 description DC1-LEAF2_Ethernet1
   neighbor 172.31.255.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.9 remote-as 65102
   neighbor 172.31.255.9 description DC1-LEAF3_Ethernet1
   neighbor 172.31.255.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.13 remote-as 65102
   neighbor 172.31.255.13 description DC1-LEAF4_Ethernet1
   neighbor 192.168.255.3 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.3 remote-as 65101
   neighbor 192.168.255.3 description DC1-LEAF1
   neighbor 192.168.255.4 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.4 remote-as 65101
   neighbor 192.168.255.4 description DC1-LEAF2
   neighbor 192.168.255.5 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.5 remote-as 65102
   neighbor 192.168.255.5 description DC1-LEAF3
   neighbor 192.168.255.6 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.6 remote-as 65102
   neighbor 192.168.255.6 description DC1-LEAF4
