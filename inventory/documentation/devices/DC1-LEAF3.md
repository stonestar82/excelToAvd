...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | DC1-L2LEAF2A_Ethernet1 | *trunk | *- | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | Connection to DC1-SPINE1-Ethernet3 | routed | - | 172.31.255.9/31 | default | 1500 | false | - | - |
| Ethernet2 | Connection to DC1-SPINE2-Ethernet3 | routed | - | 172.31.255.11/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description Connection to DC1-SPINE1-Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description Connection to DC1-SPINE2-Ethernet3
   no shutdown
   mtu 1500
   no switchport
