...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | Connection to DC1-LEAF1-Ethernet2 | routed | - | 172.31.255.2/31 | default | 1500 | false | - | - |
| Ethernet2 | Connection to DC1-LEAF2-Ethernet2 | routed | - | 172.31.255.6/31 | default | 1500 | false | - | - |
| Ethernet3 | Connection to DC1-LEAF3-Ethernet2 | routed | - | 172.31.255.10/31 | default | 1500 | false | - | - |
| Ethernet4 | Connection to DC1-LEAF4-Ethernet2 | routed | - | 172.31.255.14/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description Connection to DC1-LEAF1-Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description Connection to DC1-LEAF2-Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description Connection to DC1-LEAF3-Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description Connection to DC1-LEAF4-Ethernet2
   no shutdown
   mtu 1500
   no switchport
