...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | Connection to DC1-SPINE1-Ethernet2 | routed | - | 172.31.255.5/31 | default | 1500 | false | - | - |
| Ethernet2 | Connection to DC1-SPINE2-Ethernet2 | routed | - | 172.31.255.7/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description Connection to DC1-SPINE1-Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description Connection to DC1-SPINE2-Ethernet2
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | DC1-L2LEAF1A_Po1 | switched | trunk | - | - | - | - | - | - | - |
