...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.22.196 | 192.168.22.1 |
...
| 172.31.255.31 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 172.31.255.39 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
...
router bgp 65100
   ...
   neighbor 172.31.255.31 remote-as 65101
   neighbor 172.31.255.31 description DC1-LEAF3A_Ethernet4
   neighbor 172.31.255.39 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.39 remote-as 65101
   neighbor 172.31.255.39 description DC1-LEAF3B_Ethernet4
