...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.22.200 | 192.168.22.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF3 | Vlan4094 | 10.255.252.7 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | DC1-L2LEAF1A_Ethernet1 | *trunk | *110-112 | *- | *- | 5 |
| Ethernet6 | DC1-L2LEAF2A_Ethernet1 | *trunk | *110-112 | *- | *- | 6 |
| Ethernet7 | MLAG_PEER_DC1-LEAF3B_Ethernet7 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
| Ethernet8 | MLAG_PEER_DC1-LEAF3B_Ethernet8 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
...
!
interface Ethernet7
   description MLAG_PEER_DC1-LEAF3B_Ethernet7
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description MLAG_PEER_DC1-LEAF3B_Ethernet8
   no shutdown
   channel-group 7 mode active
```
...
| Port-Channel7 | MLAG_PEER_DC1-LEAF3B_Po7 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel7
   description MLAG_PEER_DC1-LEAF3B_Po7
   no shutdown
   switchport
...
| 172.31.255.24 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 172.31.255.26 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 172.31.255.28 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
| 172.31.255.30 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - |
