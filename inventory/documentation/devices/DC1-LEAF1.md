...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | Connection to DC1-SPINE1-Ethernet1 | routed | - | 172.31.255.1/31 | default | 1500 | false | - | - |
| Ethernet2 | Connection to DC1-SPINE2-Ethernet1 | routed | - | 172.31.255.3/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description Connection to DC1-SPINE1-Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description Connection to DC1-SPINE2-Ethernet1
   no shutdown
   mtu 1500
   no switchport
